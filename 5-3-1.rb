...
class Numeric
  def round_to_increment_of(divider)
    divider * ((self.to_f / divider).round)
  end

  def percent_of_rounded(n)
    (((self.to_f / 100.0) * n.to_f).round_to_increment_of(2.5)).to_s.gsub(".0", "")
  end

  def percent_of_not_rounded(n)
    (self.to_f / 100.0) * n.to_f
  end
end
...
bp_orm = 90.percent_of_not_rounded(bp_theoretical_orm)
bs_orm = 90.percent_of_not_rounded(bs_theoretical_orm)
dl_orm = 90.percent_of_not_rounded(dl_theoretical_orm)
